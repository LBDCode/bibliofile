...
class Saved extends Component {
    ...
    render() {
      ...
      var searchMessage = '<div style="pointer-events: auto;">It looks like your reading list is empty! User our ';
      searchMessage += <Link to="/search">Search</Link>
      searchMessage += ' feature to add some books.';
